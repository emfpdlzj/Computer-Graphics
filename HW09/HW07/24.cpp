...
int main(void){
    ...
    glfwWindowHint(GLFW_SAMPLES, 8); //3.(Optional) glfwInit와 glfwCreateWindow 사이에 glWindowHint로 anti aliasing을 켜 봄
#ifdef __APPLE__
    ...
    programID = loadShaders(
        "/Users/emfpdlzj/Desktop/Computer-Graphics/HW09/HW07/shader.vs",
        "/Users/emfpdlzj/Desktop/Computer-Graphics/HW09/HW07/shader.fs"
    );
    loadJ3A("/Users/emfpdlzj/Desktop/Computer-Graphics/HW09/HW07/bunny.j3a");
    ...
    glEnable(GL_DEPTH_TEST); // 1.이 과정을 통해 z-buffer algorithm이 수행되고 뒤의 것을 안 그려 집니다.
...
void render(GLFWwindow* window){
    ...
    glClear(GL_COLOR_BUFFER_BIT| GL_DEPTH_BUFFER_BIT); //2.매번 새로운 z-buffer 상태에서 시작하기 위해
