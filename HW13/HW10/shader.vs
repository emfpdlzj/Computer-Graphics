...
uniform mat4 shadowProjMat; // light에서 보는 projection 행렬
uniform mat4 shadowViewMat; // light에서 보는 view 행렬
...
void main(){
   ...
   // gl_Position = shadowProjMat * shadowViewMat * worldCoord; //과제34 제출용 
}
